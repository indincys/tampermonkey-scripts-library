// ==UserScript==
// @name         IDC Flare Auto Expand Nested Replies
// @name:zh-CN   IDC Flare 自动展开楼中楼
// @namespace    https://idcflare.com/
// @version      1.0.0
// @description  Redirect IDC Flare topics to Discourse nested view, preserve Cmd/Ctrl new-tab opening, and auto-expand visible nested replies while reading.
// @description:zh-CN 将 IDC Flare 帖子切到嵌套阅读视图，保留 Cmd/Ctrl 新标签页打开，并在阅读时自动展开可见楼中楼回复。
// @author       Codex
// @match        https://idcflare.com/*
// @match        https://go.idcflare.com/*
...
(function () {
  ...
  function isIdcflareTopicHost(url) {
    return url.hostname === "idcflare.com" || url.hostname === "go.idcflare.com";
  }
  ...
  function toNestedTopicUrl(rawUrl) {
    ...
    if (!isIdcflareTopicHost(url) || shouldSkipTopicRedirect(url)) {
      return null;
    }
